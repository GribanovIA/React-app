          ...
          можно навестить handleSubmit на <Button onClick />, тогда все работает */}
            <Form>
              ...
              <FormItem>
                ...
                <Button onClick={props.setAuthWithVK} type="primary" htmlType="button" style={{ marginLeft: "35px" }}>
                  Login через Vk
                </Button>
              </FormItem>
...
export const LoginForm = reduxForm({
  form: "simple", // Уникальное наименование формы
  onChange(values,dispatch){
    dispatch(clearSubmitErrors('simple')); //Сбрасываем серверные ошибки
  } 
})(SimpleForm);
